...
void loop()
{
  ...
  Serial.print("readByte():       "); Serial.println(timestamps[5]);
  Serial.print("readShort():      "); Serial.println(timestamps[6]);
  Serial.print("readLong():       "); Serial.println(timestamps[7]);
  Serial.print("readLongLong():   "); Serial.println(timestamps[8]);
  Serial.print("readFloat():      "); Serial.println(timestamps[9]);
  Serial.print("invokeFunction(): "); Serial.println(timestamps[10]);
  Serial.println();
